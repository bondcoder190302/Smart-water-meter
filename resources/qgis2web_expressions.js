...
function exp_Pressure_readings_3rule0_eval_expression(context) {
    // Prdiff < - 150

    var feature = context.feature;
    
    if (feature.properties) {
        return (feature.get('Prdiff')  < - 150 );
    } else {
        return (feature.get('Prdiff')  < - 150 );
    }
}
...
function exp_Pressure_readings_3rule1_eval_expression(context) {
    // Prdiff > - 150
